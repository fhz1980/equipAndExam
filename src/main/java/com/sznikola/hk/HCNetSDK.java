...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(new File("./dll/HCNetSDK.dll").getAbsolutePath(), HCNetSDK.class);
    /***宏定义***/
    //常量
...
{
    //PlayCtrl.dll
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(new File("./dll/PlayCtrl.dll").getAbsolutePath(), PlayCtrl.class);
